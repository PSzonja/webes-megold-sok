...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3817306398ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=adatok&table=tabla">`adatok`.`tabla`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="34585f444b5f523b2b5a2b472e5c4931">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE tabla(Username VARCHAR (250) NOT NULL, Titkos VARCHAR (10) NOT NULL);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="adatok" targettable="tabla">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tabla`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="adatok" targettable="tabla">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO tabla (Username, Titkos) VALUES (&#039;katica85&#039;, &#039;piros&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="adatok" targettable="tabla">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO tabla (Username, Titkos) VALUES (&#039;katica85@gmail.com&#039;, &#039;piros&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="adatok" targettable="tabla">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO tabla (Username, Titkos) VALUES (&#039;katika@gmail.com&#039;, &#039;piros&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="adatok" targettable="tabla">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO tabla (Username, Titkos) VALUES (&#039;nagysanyi@gmail.hu&#039;, &#039;feher&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="adatok" targettable="tabla">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM tabla WHERE Username=&#039;katica85&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="adatok" targettable="tabla">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM tabla WHERE Username=&#039;katica85@gmail.com&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="adatok" targettable="tabla">
                            <div class="action_content">
